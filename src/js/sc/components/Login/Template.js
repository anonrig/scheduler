...
sc.components.Login.Template.prototype.base = function(items) {
    return '<div class="loginCarousel">' +
            '<div class="items">' +
                '<div class="item view"><img src="img/search.png"/>' +
                ...
                '</div>' +
                '<div class="item view"><img src="img/search2.png" />' +
                ...
                '</div>' +
                '<div class="item view"><img src="img/detailpage.png" />' +
                ...
                '</div>' +
                '<div class="item view"><img src="img/coursecard.png" />' +
                ...
                '</div>' +
                '<div class="item view"><img src="img/schedule.png" />' +
